  ...
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      <el-form-item label="客户名称">
        <el-input v-model="dataForm.dataAmount" placeholder="客户名称"></el-input>
      </el-form-item>
      ...
      <el-form-item label="净重">
        <el-input v-model="dataForm.dataAmount" placeholder="净重"></el-input>
      </el-form-item>
      <el-form-item label="车辆排放标准">
        <el-input v-model="dataForm.effectiveData" placeholder="车辆排放标准"></el-input>
      </el-form-item>
